...
from .yolov8_detector import YOLOv8Detector, get_yolov8_detector


def get_detector() -> Union[SAM3Detector, YOLOv8Detector, "HybridDetector"]:
    """
    Get the appropriate detector based on configuration.

    Returns:
        Detector instance (HybridDetector, YOLOv8Detector, or SAM3Detector)
    """
...
DetectorType = Union[SAM3Detector, YOLOv8Detector, "HybridDetector"]
